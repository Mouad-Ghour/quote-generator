  ...
  return (
    <>
      ...
      <GradientBackgroundCon>
        ...
        {/* Footer */}
        <FooterCon style={{marginBottom: "20px"}}>
          <>
            Quotes Generated by <FooterLink href={"https://zenquotes.io"} target='_blank' rel='noopener noreferrer'>ZenQuotes</FooterLink>
            <br />
            Developed with Nextjs by <FooterLink href="https://www.linkedin.com/in/mouadghourdou/" target="_blank" rel="noopener noreferrer"> @MouadGh </FooterLink>
            <br />
            For more Documentation, check out my Github <FooterLink href="https://github.com/Mouad-Ghour" target="_blank" rel="noopener noreferrer"> @Mouad-Ghour </FooterLink>
          </>
        </FooterCon>
